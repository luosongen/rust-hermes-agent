...
/// OpenRouter Streaming Tool Call
#[derive(Debug, Deserialize)]
struct OpenRouterStreamToolCall {
    ...
    function: OpenRouterStreamFunction,
}

/// OpenRouter Streaming Function Call
#[derive(Debug, Deserialize)]
        ...
        while let Some(chunk) = stream.next().await {
            ...
            for line in text.lines() {
                if line.starts_with("data: ") {
                    ...
                    if let Ok(delta) = serde_json::from_str::<OpenRouterStreamDelta>(data) {
